                                ...
                                foreach ($kuliner as $k) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url()?>administrator/hapus_kuliner/<?=$k['id_kuliner']?>" class="btn btn-danger waves-effect" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini ?')">Hapus</a>

                                            <a href="<?=base_url()?>administrator/galery_kuliner/<?=$k['id_kuliner']?>" class="btn btn-primary waves-effect">Isi Galery Kuliner</a>
                                        </td>
                                    </tr>
                                <?php $no++; } ?>
                            </tbody>
