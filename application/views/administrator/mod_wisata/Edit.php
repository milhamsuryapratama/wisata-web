<div class="container-fluid">
    ...
    <div class="row clearfix">
        ...
        <form method="post" action="<?=base_url()?>administrator/update_wisata/<?=$wisata['id_wisata']?>" enctype="multipart/form-data">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea id="deskripsi" name="deskripsi" class="form-control"><?=$wisata['deskripsi']?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
