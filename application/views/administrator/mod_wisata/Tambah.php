<div class="container-fluid">
    ...
    <div class="row clearfix">
        ...
        <form method="post" action="tambah_wisata" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="nama_wisata" class="form-control" placeholder="Isi Nama Wisata">
                                    </div>
                                </div>                            
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="alamat_wisata" class="form-control" placeholder="Isi Alamat Wisata">
                                    </div>
                                </div>  
                            </div>
                            <div class="col-sm-12">
