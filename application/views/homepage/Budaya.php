...
<section class="section section-single">
	<div class="container-fluid">
		...
		<div class="single-body">
			<?php foreach ($budaya as $w) { ?>
				<div class="col">
					<img src="<?=base_url()?>assets/foto/budaya/<?=$w['foto_budaya']?>">
					<div class="overlay">
						<div class="caption">
							<div class="caption-text">
								...
								<b>Rp. 15.000</b> <br> -->
								<br>
								<a href="<?=base_url()?>budaya/detail/<?=$w['slug_budaya']?>" class="btn btn-orange btn-round">See Details</a>
							</div>
						</div>
					</div>
				</div>
